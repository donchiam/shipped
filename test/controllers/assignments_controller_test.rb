...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { boat: @assignment.boat, containers: @assignment.containers, job: @assignment.job } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { boat: @assignment.boat, containers: @assignment.containers, job: @assignment.job } }
